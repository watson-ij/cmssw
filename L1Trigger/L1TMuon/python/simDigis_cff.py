...
_phase2_SimL1TMuonTask_GE0 = SimL1TMuonTask.copy()
_phase2_SimL1TMuonTask_GE0.remove(me0TriggerAllDigiTask)

from Configuration.Eras.Modifier_phase2_muon_cff import phase2_muon
(stage2L1Trigger & phase2_muon).toReplaceWith( SimL1TMuonTask, _phase2_SimL1TMuonTask )

from Configuration.ProcessModifiers.phase2_GE0_cff import phase2_GE0
(stage2L1Trigger & phase2_GE0).toReplaceWith( SimL1TMuonTask, _phase2_SimL1TMuonTask_GE0 )
