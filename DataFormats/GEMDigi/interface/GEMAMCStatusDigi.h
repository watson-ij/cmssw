...
class GEMAMCStatusDigi {
 ...
 public:
  GEMAMCStatusDigi(gem::AMCdata amc);
  GEMAMCStatusDigi(){}
  ...
  uint16_t orbitNum()  const {return m_orbitNum;} ///<Returns Orbit number
  ...
  uint8_t  ttsState()  const {return m_ttsState;}        ///<Returns TTS state
 ...
 private:
  ...
  uint16_t m_orbitNum;    ///<Orbit number:16 
  uint16_t m_BID;
